 ...
 */
public interface IWilliamsPercentRDataset extends XYDataset {

	/**
	 * Returns the Williams %R for an item within a series.
	 * 
	 * @param series
	 *            the series index.
	 * @param item
	...
	/**
	 * Returns the Williams Percent R for an item within a series.
	 * 
	 * @param series
	 *            the series index.
	 * @param item
