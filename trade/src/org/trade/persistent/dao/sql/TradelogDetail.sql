...
if(data.sortCol = 'Total' , null, if(data.isOpenPosition is null,data.longShort ,if(data.isOpenPosition = 1, data.longShort,  if(data.filledDate is null,data.longShort, null))))  as longShort,
if(data.sortCol = 'Total' , null, if(data.isOpenPosition is null,data.tier ,if(data.isOpenPosition = 1, data.tier, if(data.filledDate is null, data.tier, null))))  as tier,
if(data.sortCol = 'Total' , null, if(data.isOpenPosition is null,data.marketBias ,if(data.isOpenPosition = 1, data.marketBias, if(data.filledDate is null, data.marketBias, null)))) as marketBias,
if(data.sortCol = 'Total' , null, if(data.isOpenPosition is null,data.marketBar ,if(data.isOpenPosition = 1, data.marketBar, if(data.filledDate is null, data.marketBar, null)))) as marketBar,
if(data.sortCol = 'Total' , null, if(data.isOpenPosition is null,data.name ,if(data.isOpenPosition = 1, data.name, if(data.filledDate is null, data.name, null))))  as name,
if(data.sortCol = 'Total' , null, if(data.isOpenPosition is null,data.status ,if(data.isOpenPosition = 1, data.status, if(data.filledDate is null, data.status, null))))  as status,
...
if(data.sortCol = 'Total' , null, if(data.isOpenPosition is null,data.side ,if(data.isOpenPosition = 1, data.side, if(data.filledDate is null, data.side, null))))  as side,
