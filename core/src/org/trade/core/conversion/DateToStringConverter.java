 ...
 * @version $Id: DateToStringConverter.java,v 1.1 2001/09/19 20:31:04 clay Exp $
 * @author Simon Allen
 */
public class DateToStringConverter implements JavaTypeConverter {
	 ...
	 *                thrown if the valueToConvert is not of type java.util.Date * @see org.trade.core.conversion.JavaTypeConverter#convert(Object)
	 */
