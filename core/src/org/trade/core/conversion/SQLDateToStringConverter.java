 ...
 * @version $Id: SQLDateToStringConverter.java,v 1.1 2001/09/19 20:31:03 clay
 *          Exp $
 * @author Simon Allen
 */
public class SQLDateToStringConverter implements JavaTypeConverter {
	 ...
	 *                thrown if the valueToConvert is not of type java.sql.Date * @see org.trade.core.conversion.JavaTypeConverter#convert(Object)
	 */
