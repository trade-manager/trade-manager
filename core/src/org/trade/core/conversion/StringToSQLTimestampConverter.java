 ...
 * @version $Id: StringToSQLTimestampConverter.java,v 1.1 2001/09/19 20:31:01
 *          clay Exp $
 * @author Simon Allen
 */
public class StringToSQLTimestampConverter extends StringToObjectConverter {
	 ...
	 * @return Object the String converted to a java.sql.Timestamp * @exception IllegalArgumentException
