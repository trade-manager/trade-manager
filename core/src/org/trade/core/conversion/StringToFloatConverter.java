 ...
 * @version $Id: StringToFloatConverter.java,v 1.1 2001/09/19 20:31:02 clay Exp
 *          $
 * @author Simon Allen
 */
public class StringToFloatConverter extends StringToObjectConverter {
	 ...
	 * @return Object the String converted to a Float * @exception IllegalArgumentException
