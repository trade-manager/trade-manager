Installation Prerequisites trade-manager 2.11
...
4.	Edit Built.bat in the C:\trade-manager directory. Change the JAVA_HOME property to point to the Java J2SE dir. Current setting is C:\Program Files\Java\jdk1.7.0_17. Check which dir was created when you installed J2SE.

5.  In build.bat un-comment the target createDB as first time you want to create the DB and the Trader user i.e. remove the <b>rem</b>

rem Create the database user and default data

<b>rem</b> java -classpath "%CLASSPATH%"  org.apache.tools.ant.Main -buildfile ant/build.xml createDB
...
5.  In build.sh un-comment the target createDB as first time you want to create the DB and the Trader user i.e. remove the <b>#</b>

rem Create the database user and default data

<b>#</b> java -classpath "%CLASSPATH%"  org.apache.tools.ant.Main -buildfile ant/build.xml createDB
